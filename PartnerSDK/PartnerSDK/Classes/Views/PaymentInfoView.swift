...
protocol PaymentInfoViewDelegate: AnyObject {
...
class PaymentInfoView: UIView {
    ...
    /// Convenience function for setting up the initial state of the PaymentInfoView with saved card information
    func setupSavedCard(lastFour: String, cardType: CardType) {
        self.lastFour = lastFour
        self.cardType = cardType
        self.toggleRemoveButton(show: true)
        self.isValid = true
    }
}
