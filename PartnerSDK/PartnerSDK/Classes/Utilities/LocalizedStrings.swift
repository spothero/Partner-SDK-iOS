...
enum LocalizedStrings {
    ...
    static let Phone = NSLocalizedString("Phone",
                                         comment: "Title for Phone row of checkout screen")
    ...
    static let PhoneNumberFormattingErrorMessage = NSLocalizedString("Please enter a valid phone number.",
    ...
    static let NonAcceptedCreditCardErrorMessage = NSLocalizedString(
        "Please enter a Visa, Discover, MasterCard, or American Express card.",
    ...
    static let License = NSLocalizedString("License", comment: "License")
    ...
    static let NoSpotsNearby = NSLocalizedString("No spots nearby",
    ...
    static let EditInfoWarningTitle = NSLocalizedString("Edit Your Checkout Info?",
                                                        comment: "Title for warning about changing your saved info")
    static let EditInfoWarningMessage = NSLocalizedString("Editing your checkout info will clear all previously saved info.",
                                                          comment: "Message for warning about changing your saved info")
    static let Edit = NSLocalizedString("Edit", comment: "Edit")
    static let Cancel = NSLocalizedString("Cancel", comment: "Cancel")

    static let LicensePlateInstructions = NSLocalizedString("Enter your license plate exactly how it displays.",
                                                            comment: "Instructions for adding a license plate")
    static let LicensePlateStateTitle = NSLocalizedString("License Plate State (Optional)",
                                                          comment: "Title for license plate state button")
    static let AddLicensePlate = NSLocalizedString("Add License Plate", comment: "Add License Plate")
    static let SelectedLicensePlateStateTitle = NSLocalizedString("License State", comment: "Title when a state is selected")
}
