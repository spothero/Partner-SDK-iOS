...
class SpotCardsUITests: BaseUITests {
    ...
    func skip_testSwipingThroughSpotCards() {
        ...
        guard spotCardsCollectionView.cellForItem(at: indexPathForFirstCell) as? SpotCardCollectionViewCell != nil else {
...
//        XCTAssertFalse(firstCell.buyButton.isEnabled)
        ...
        guard spotCardsCollectionView.cellForItem(at: indexPathForSecondCell) as? SpotCardCollectionViewCell != nil else {
            XCTFail("Cannot get active spot card cell")
            return
        }
