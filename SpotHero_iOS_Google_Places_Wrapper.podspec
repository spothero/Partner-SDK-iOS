...
A wrapper class for the Google Places API.
    ...
    s.source_files          = 'GooglePlacesWrapperPod_Files/*', 'SpotHero_iOS_Partner_SDK/Classes/*/GooglePlace*.swift', 'SpotHero_iOS_Partner_SDK/Classes/Network/JSONDictionary.swift'
