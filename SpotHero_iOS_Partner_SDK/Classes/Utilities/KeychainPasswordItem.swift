...
struct KeychainPasswordItem {
    ...
    init(service: String = KeychainConfiguration.serviceName,
         account: String,
    ...
    func savePassword(_ password: String) throws {
        ...
        let encodedPassword = password.data(using: String.Encoding.utf8)! //swiftlint:disable:this force_unwrapping
